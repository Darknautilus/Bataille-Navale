/**
\page instComp Installation et Compilation

\section install Installation

\subsection installWin Windows

Ce programme utilise les bibliothèques SDL 1.2.15, SDL_image et SDL_ttf.<br/>
Toutes les DLL nécessaires à Windows sont incluses. Et doivent être placées dans le même dossier que l'exécutable.

\subsection installMac MacOS X
...
\subsection compWin Windows

Pour pouvoir compiler, vous devez télécharger des fichiers spécifiques.<br/>
...
\subsection compMac MacOS X

Procédure pour XCode :<br/>
